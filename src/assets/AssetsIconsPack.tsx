...
const AssetsIconsPack: IconPack<ImageProps | SvgProps> = {
  ...
  icons: {
    ...
    money_basic: createIcon(Icons['money_basic']),
    delete: createIcon(Icons['delete']),
    mess: createIcon(Icons['mess']),
    'dots-nine': createIcon(Icons['dots-nine']),
    'scan-1': createIcon(Icons['scan-1']),
    nut: createIcon(Icons['nut']),
    discord: createIcon(Icons['discord']),
    'globe-simple': createIcon(Icons['globe-simple']),
    'instagram-logo': createIcon(Icons['instagram-logo']),
    telegram: createIcon(Icons['telegram']),
    'twitter-logo': createIcon(Icons['twitter-logo']),
    'upload-simple': createIcon(Icons['upload-simple']),
    robot: createIcon(Icons['robot']),
    'image-square': createIcon(Icons['image-square']),
    'users-four': createIcon(Icons['users-four']),
    layout: createIcon(Icons['layout']),
    'arrow-down-up': createIcon(Icons['arrow-down-up']),
    atom: createIcon(Icons['atom']),
    'stack-simple': createIcon(Icons['stack-simple']),
    'faders-horizontal': createIcon(Icons['faders-horizontal']),
    'arrows-left-right': createIcon(Icons['arrows-left-right']),
  },
};
